...
def login_and_generate_token():
    ...
    print(" It will redirect you to a google.com page. The page might look blank or broken—that is normal!")
    ...
    try:
        ...
        print("Make sure you copied the whole thing. It should look like: https://google.com/?auth_code=...")
        return
